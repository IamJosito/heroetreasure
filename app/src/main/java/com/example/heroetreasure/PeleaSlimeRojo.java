...
public class PeleaSlimeRojo extends AppCompatActivity {
    ImageView img;
    Clase clase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pelea_slime_rojo);
        ...
        btnGolpe1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (vidaSlime <= 0){
                    Intent intent2 = new Intent(PeleaSlimeRojo.this, EleccionMontana2.class);
